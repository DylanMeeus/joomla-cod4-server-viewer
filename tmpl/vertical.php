...
$doc->addStyleSheet ( 'modules/mod_cod4_serverstatus/css/vertical.css' ); //dodati drgi stylesheet za vertical i horizontal
?>

<div class="cod4serverstatus_holder">
  <div class="cod4serverstatus_left">
    <? echo '<img src="'.$baseurl.'images/serverstats/mp_'.$map_name.'.jpg" alt="'.$map_name.'" />'; ?><br>
    <?=$server_name?><br>
    IP:
    <? if ($defined_server_ip_link =="") echo '<b>'.$server_ip.'</b>'; else echo '<a href="http://'.$defined_server_ip_link.'" target="_blank"><b>'.$server_ip.'</b></a>'; ?><br>
    Current map: <?=$map_name?><br>
    Game type: <?=$game_type?><br>
    Number of players: <?=$player_number?>
  </div>
  ...
  <div class="cod4serverstatus_left">
    <a href="http://www.gametracker.com/server_info/<?php echo $server_ip; ?>:<?php echo $server_port; ?>/" target="_blank"><img src="http://cache.www.gametracker.com/server_info/<?php echo $server_ip; ?>:<?php echo $server_port; ?>/b_160_400_1_ffffff_c5c5c5_ffffff_000000_0_1_1.png" border="0" alt="" /></a>
  </div>
</div>